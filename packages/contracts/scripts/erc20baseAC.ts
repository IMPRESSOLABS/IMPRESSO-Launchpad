...
async function main() {
    ...
    const contract = await upgrades.deployProxy(erc20base, [TOKEN_NAME, TOKEN_SYMBOL, MAX_TOTAL_SUPPLY, USE_MAX_TOTAL_SUPPLY, deployer.address], { initializer: 'initialize', kind: 'uups' });
